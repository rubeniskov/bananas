...
icon = "cloud"
`);
    await fs.writeFile(path.join(ext, 'exports.toml'),
      `id = "exports"
label = "Exports"
socket = "${this.tmp}/exports.sock"
api_prefix = "/api/exports"
order = 20
icon = "share-2"
`);
...
icon = "users"
`);
    await fs.writeFile(path.join(ext, 'stats.toml'),
      `id = "stats"
label = "Stats"
socket = "${this.tmp}/stats-web.sock"
