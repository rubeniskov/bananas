...
use crate::{api, icons::Icon, permissions::PermissionsModal};
...
pub fn Browser(props: BrowserProps) -> Element {
    ...
    let mut perms_tick = use_signal(|| 0u32);
    ...
    rsx! {
                ...
                match &*listing.read_unchecked() {
                    ...
                    Some(Ok(l)) => rsx! {
                        ...
                        div { class: "modal-footer",
                            ...
                            button {
                                class: "ghost",
                                "data-tip": "Edit owner / group / mode for this path. Allowlisted to /srv, /mnt, /media, /home, /opt.",
        ...
        if perms_open() {
            PermissionsModal {
                ...
                on_saved: move |_| {
                    perms_open.set(false);
                    // Re-fetch the directory listing so any visible mode
                    // changes show up. (browse doesn't currently render
                    // perms but the bump keeps callers in sync.)
                    perms_tick.set(perms_tick() + 1);
                }
            }
        }
    }
