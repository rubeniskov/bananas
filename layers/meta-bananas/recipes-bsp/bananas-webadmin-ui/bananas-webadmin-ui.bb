...
bananas-webadmin from /usr/share/bananas/webadmin/. Built by \
`pixi run build-webadmin` into serve/bin/bananas-webadmin-ui.tar.gz with \
...
SRC_URI = "file://bananas-webadmin-ui.tar.gz"
...
do_install() {
    # do_unpack already extracted bananas-webadmin-ui.tar.gz into WORKDIR,
    ...
    # emits next to each asset; bananas-webadmin's ServeDir serves them
